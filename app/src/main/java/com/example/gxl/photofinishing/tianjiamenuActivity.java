 ...
 */
public class tianjiamenuActivity  extends AutoLayoutActivity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        shezhisp = new shezhiSharedprefrence(tianjiamenuActivity.this);
        ...
        if(yuanlaidizhi.size()!=0) {
            guanlimenu_adapter adapter = new guanlimenu_adapter(tianjiamenuActivity.this, yuanlaidizhi);
