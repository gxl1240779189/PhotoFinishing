...
public class showPhotoDetail extends AutoLayoutActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                {
                    Intent intent = new Intent(showPhotoDetail.this, chakanPhoto.class);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.huanyuan:
                ...
                {
                    Toast.makeText(showPhotoDetail.this,"请至少选择一项",Toast.LENGTH_SHORT).show();
                }
                break;
    ...
    class huanyuanfile_task extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            MyDialog = myDialog.createLoadingDialog(showPhotoDetail.this, "正在还原照片");
            finishDialog = myDialog.createLoadingfinishDialog(showPhotoDetail.this, "已完成");
            MyDialog.show();
            super.onPreExecute();
        }
    ...
    class deletefile_task extends AsyncTask<Void, Void, Void> {
        ...
        @Override
        protected void onPreExecute() {
            MyDialog = myDialog.createLoadingDialog(showPhotoDetail.this, "正在删除照片");
            finishDialog = myDialog.createLoadingfinishDialog(showPhotoDetail.this, "已完成");
            MyDialog.show();
            super.onPreExecute();
        }
