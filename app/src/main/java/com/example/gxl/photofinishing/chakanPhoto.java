 ...
 */
public class chakanPhoto extends AutoLayoutActivity implements View.OnClickListener {
    ViewPager viewpaper;
    ArrayList<View> list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mImageLoader = other.ImageLoader.build(chakanPhoto.this);
    ...
    public void Createdialog(final int view_flag) {
        final View dialogView = LayoutInflater.from(chakanPhoto.this).inflate(R.layout.delete_dialog, null);
        dialog = new Dialog(chakanPhoto.this);
